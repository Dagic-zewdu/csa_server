const { emitLetterrs, createLetter, editLetter, deleteLetter, getLetters } = require("./controllers/letter");
const { saveMessage, getMessages, updateMessages, deleteMessage, deleteLetterMessage } = require("./controllers/messages");
...
socket.on('submit',data=>{saveMessage(data,io)})  //for saving message
...
socket.on('typing_letter',data=>io.sockets.emit('typing_letter',{emp_id:data.emp_id}))   
